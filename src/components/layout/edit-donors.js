...
export default class Edit extends Component {
  ...
  componentDidMount() {
      axios.get('http://localhost:4000/api/donor/edit/:id'+this.props.match.params.id)
          .then(response => {
              this.setState({ 
  ...
  onSubmit(e) {
    ...
    axios.post('http://localhost:4000/donor/update/:id'+this.props.match.params.id, obj)
        .then(res => console.log(res.data));
    
    this.props.history.push('/index-create');
  }
